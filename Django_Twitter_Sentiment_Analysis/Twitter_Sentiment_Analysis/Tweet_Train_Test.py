...
class Tweet_Train_Test:
    ...
    #            print("\nwords_array: " + str(words_array))
            ...
            distinct_word_list = Tweet_Train_Test.get_distinct_words_list(Tweet_Train_Test.extend_tweets_words(tweets_array))
            training_dataset = nltk.classify.apply_features(Tweet_Train_Test.label_tweet_array, tweets_array)
    ...
    def tweet_predict(tweet_classifier, tweet_list):
        try:
            ...
            for tweet in tweet_list:
                sentiment = tweet_classifier.classify(Tweet_Train_Test.label_tweet_array(tweet.split()))
            ...
            logger.error("Exception occurred in the tweet_predict method| Exception:" + str(Ex))
